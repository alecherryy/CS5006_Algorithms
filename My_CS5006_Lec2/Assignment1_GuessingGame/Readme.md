...
- Name(s): Alessia Pizzoccheri
- How many hours did it take you to complete this Assignment? About 2 hours
- Did you collaborate with any other students/TAs/Professors? No
- Did you use any external resources? (Cite them below)
  - <a
  href="https://mathbits.com/MathBits/CompSci/LibraryFunc/rand.html">https://mathbits.com/MathBits/CompSci/LibraryFunc/rand.html</a>
  - I used this page to understand how rand() and srand() work and what seeding means
- (Optional) What was your favorite part of the assignment? Spotting the
